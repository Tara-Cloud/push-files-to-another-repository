...
pwd
echo "$CLONE_DIRECTORY/$DESTINATION_DIRECTORY$SOURCE_FILES"
if [ -d "$CLONE_DIRECTORY/$DESTINATION_DIRECTORY$SOURCE_FILES" ]; then
  rm -rfv "$CLONE_DIRECTORY/$DESTINATION_DIRECTORY$SOURCE_FILES"
fi
